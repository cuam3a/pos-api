...
exports.userInformation = exports.login = void 0;
...
const login = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userToken = yield (0, auth_1.loginService)({ user, password });
        const response = {
            status: 200,
            token: userToken
        };
...
const userInformation = ({ idUser }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userInformation = yield (0, auth_1.userInformationService)(idU);
        const response = {
            status: 200,
